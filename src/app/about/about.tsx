...
const AboutPage = () => {
  ...
  useEffect(() => {
    // Simulate a 0.5-second loading delay or use actual data fetching logic
  ...
  }, []); // The empty dependency array ensures the effect runs once on mount (like componentDidMount)
  ...
  return (
    <>
      <div className="w-full bg-white px-4 md:px-12 py-22 text-gray-800">
        {/* Header Section */}
