...
const ContactPage = () => {
  ...
  useEffect(() => {
    // Simulate a 0.5-second loading delay to show the loader on page refresh
          ...
          <div className="flex flex-col justify-center text-center sm:text-left items-center md:items-start space-y-8 w-full">
            <div>
              <h3 className="text-xl font-semibold mb-1 flex items-center justify-center md:justify-start gap-2">
                <Image height={20} width={20} src="/svg/location.svg" alt="location" />
                Address
              </h3>
              <Link
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1 flex items-center justify-center md:justify-start gap-2">
                <Image height={25} width={25} src="/svg/call.svg" alt="phone" />
                Phone
              </h3>
              <Link
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1 flex items-center justify-center md:justify-start gap-2">
                <Image height={25} width={25} src="/svg/gmail.svg" alt="email" />
                Email
              </h3>
              <Link
            ...
            <div className="pt-6">
              ...
              <div className="flex gap-4 items-center justify-center md:justify-start">
                {socialIcons.map((icon, i) => (
                  <Link href={icon.href} key={i} target="_blank" rel="noopener noreferrer">
                    <Button
                      variant="ghost"
                      size="icon"
